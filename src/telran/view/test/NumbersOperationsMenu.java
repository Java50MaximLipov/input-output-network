...
public class NumbersOperationsMenu {
	...
	static void twoNumbersAction(InputOutput io, BinaryOperator<Double> operator) {
	...
	static void performMethod(InputOutput io1) {
		Item[] items = { Item.of("Add two numbers", io -> twoNumbersAction(io, (a, b) -> a + b)),
				Item.of("Subtract two numbers", io -> twoNumbersAction(io, (a, b) -> a - b)),
				Item.of("Divide two numbers", io -> twoNumbersAction(io, (a, b) -> a / b)),
				Item.of("Multiply two numbers", io -> twoNumbersAction(io, (a, b) -> a * b)), Item.exit() };
